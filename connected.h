...
#define latency_conn		0x0000	// Default 0. Number of connection slave can skip if no data sent
#define timeout_conn		0x0c80 // range 100ms(0x000a)-32s(0x0c80) --> Value= 100*10ms= 1000ms
